...
@endpoint('razer.device.misc', 'getTrackingHeight', out_sig='y')
def get_tracking_height(self):
    """
    Get the height of the Smart Tracking system
    0 = Low
    1 = Med
    2 = High
    """
    self.logger.debug("DBus call get_tracking_height")
